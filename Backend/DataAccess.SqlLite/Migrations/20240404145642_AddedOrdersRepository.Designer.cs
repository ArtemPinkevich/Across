...
namespace DataAccess.SqlLite.Migrations
{
    ...
    [Migration("20240404145642_AddedOrdersRepository")]
    partial class AddedOrdersRepository
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.TruckRequirements", b =>
                {
                    ...
                    b.Property<int>("CarBodyRequirementId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CarBodyRequirementId");
            ...
            modelBuilder.Entity("Entities.TruckRequirements", b =>
                {
                    b.HasOne("Entities.CarBodyRequirement", "CarBodyRequirement")
                        .WithMany()
                        .HasForeignKey("CarBodyRequirementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
