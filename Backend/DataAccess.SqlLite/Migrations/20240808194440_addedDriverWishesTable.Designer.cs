...
namespace DataAccess.SqlLite.Migrations
{
    ...
    [Migration("20240808194440_addedDriverWishesTable")]
    partial class addedDriverWishesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportationOrderUser", b =>
                {
                    b.Property<int>("OrdersOfferedByDriverId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("PossibleDriversId")
                        .HasColumnType("TEXT");

                    b.HasKey("OrdersOfferedByDriverId", "PossibleDriversId");

                    b.HasIndex("PossibleDriversId");

                    b.ToTable("DriverAndOrderWishes", (string)null);
                });
            ...
            modelBuilder.Entity("TransportationOrderUser", b =>
                {
                    ...
                    b.HasOne("Entities.User", null)
                        .WithMany()
                        .HasForeignKey("PossibleDriversId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
