...
namespace DataAccess.SqlLite.Migrations
{
    ...
    [Migration("20240512202750_orderChangeHistoryTable")]
    partial class orderChangeHistoryTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.TransferChangeHistoryRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Entities.TransferChangeHistoryRecord", b =>
                {
                    b.HasOne("Entities.User", "AssignedDriver")
                        .WithMany()
                        .HasForeignKey("AssignedDriverId");

                    b.HasOne("Entities.User", "AssignedLawyer")
                        .WithMany()
                        .HasForeignKey("AssignedLawyerId");

                    b.HasOne("Entities.User", "AssignedManager")
                        .WithMany()
